...
class SearchServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Search = channel.unary_unary(
                '/emailsearch_v2.SearchService/Search',
        ...
        self.EmbedAndStore = channel.unary_unary(
                '/emailsearch_v2.SearchService/EmbedAndStore',
...
def add_SearchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'emailsearch_v2.SearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('emailsearch_v2.SearchService', rpc_method_handlers)
