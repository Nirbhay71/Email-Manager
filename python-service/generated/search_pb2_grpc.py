...
class EmailSearchServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.EmbedAndStore = channel.unary_unary(
                '/emailsearch.EmailSearchService/EmbedAndStore',
...
def add_EmailSearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'emailsearch.EmailSearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('emailsearch.EmailSearchService', rpc_method_handlers)
